  ...
  return (
    <section className="min-h-screen flex flex-col items-center justify-center bg-gradient-to-r from-indigo-50 to-purple-100 py-20 px-4">
      <div className="max-w-2xl w-full bg-white rounded-2xl shadow-xl p-10 text-center">
        <h1 className="text-4xl md:text-5xl font-bold text-indigo-700 mb-4">Wholesale Portal</h1>
        <p className="text-lg md:text-xl text-gray-700 mb-8">
          Welcome to Incolors B2B Wholesale Platform for resellers and distributors.<br/>
          Access exclusive offers, bulk pricing, and dedicated support for your business.
        </p>
